...
! most of the PARAMETERS are made PUBLIC because they are used somehow in the dia_wri routine (flx)      
   ...
   INTEGER , PUBLIC, PARAMETER ::   jp_snow = 9   ! index of snow (solid prcipitation)       (kg/m2/s)
   INTEGER , PUBLIC, PARAMETER ::   jp_tdif = 10  ! index of tau diff associated to HF tau   (N/m2)   at T-point
