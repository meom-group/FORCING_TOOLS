...
!!!----------------------------------------------------------------------------
  ...
  IF ( narg == 0 ) THEN
     PRINT *,' usage :  mkclimato_daily ''list of data files'' '
     PRINT *,'      '
     PRINT *,'     PURPOSE :'
     PRINT *,'       Compute a daily climatology of the input daily files.'
     PRINT *,'      '
     PRINT *,'     ARGUMENTS :'
  ...
  PRINT *, nt, nt+1,nt+nspan, -nspan+1,nt-nspan+1, nt+2*nspan
  DO ji=1,npiglo
     DO jj=1,npjglo
        tmp=0.
